 ...
 * status code.
 *
 * The priority queue is allocated using the allocators specified in the
 * PQueueConf struct. The allocation may fail if the underlying allocator fails.
 * It may also fail if the values of exp_factor and capacity in the ArrayConf
...
/**
 * Destroys the specified priority queue structure along with all the data it
 * holds.
 *
